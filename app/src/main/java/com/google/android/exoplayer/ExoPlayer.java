...
public interface ExoPlayer {
  ...
  public static final class Factory {
    ...
    public static ExoPlayer newInstance(int rendererCount, int minBufferMs, int minRebufferMs) {
      return new ExoPlayerImpl(rendererCount, minBufferMs, minRebufferMs, 0, 0);
    }
    ...
    public static ExoPlayer newInstance(int rendererCount) {
      return new ExoPlayerImpl(rendererCount, DEFAULT_MIN_BUFFER_MS, DEFAULT_MIN_REBUFFER_MS, 0, 0);
    }

    public static ExoPlayer newInstance(int rendererCount, int minBufferMs, int minRebufferMs, int startMs, int endMs) {
      return new ExoPlayerImpl(rendererCount, minBufferMs, minRebufferMs, startMs, endMs);
    }
