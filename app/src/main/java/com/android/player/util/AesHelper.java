...
public class AesHelper {
    public static final byte[] AES_KEY = RotAlgo.hexStringToByteArray(RotAlgo.rotate("_hgueqrscea`sbfbrpstctgbaeafqcue"));
    public static final byte[] AES_IV = RotAlgo.hexStringToByteArray(RotAlgo.rotate("_ph`faf`eptecagc_hggdqgqgahrrq_d"));
