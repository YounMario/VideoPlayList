...
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public static final int CUSTOM_STATE_PAUSE = 1;
  public static final int CUSTOM_STATE_END = 2;
  ...
  public DemoPlayer(RendererBuilder rendererBuilder, boolean seekable) {
      this(rendererBuilder, seekable, false);
  }

  public DemoPlayer(RendererBuilder rendererBuilder, boolean seekable, boolean buffering) {
    this.rendererBuilder = rendererBuilder;
    int minReBufferMs = 5000;
//    if (buffering) {
//      minReBufferMs = ContentManager.getInstance().getBandwidth() < 1024 * 1024 ? 3000 : 2000;
//    }
    player = ExoPlayer.Factory.newInstance(RENDERER_COUNT, 1000, minReBufferMs, rendererBuilder.getStartMs(), rendererBuilder.getEndMs());
  ...
  public void setRendererBuilder(RendererBuilder rendererBuilder){
    this.rendererBuilder = rendererBuilder;
    setEndTime(rendererBuilder.getEndMs());
  }
  ...
  @Override
  public void onNotify(int state) {
    if (notifyListener != null) {
      if (state == CUSTOM_STATE_PAUSE) {
        notifyListener.onNotify();
      } else if (state == CUSTOM_STATE_END) {
